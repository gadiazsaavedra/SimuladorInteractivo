...
const anioFabricacion = ['', '2021', '2020', '2019', '2018']
//                             0                   1                 2                     3
...
//marcas.splice(5, 1) //elimina el elemento en la posición 5 del array
//marcas.splice(3, 3) //elimina el elemento en la posición 3, 4, 5 del array
...
function buscarYeliminar() {
    const borroElemento = prompt("Ingrese la marca que desea quitar:")
    const indice = marcas.indexOf(borroElemento)
        if (indice > -1) {

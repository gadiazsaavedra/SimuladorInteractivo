...
const areaResidencia = ['', 'Ciudad/Área urbana', 'Conurbano', 'Pequeña ciudad/pueblo', 'Barrio privado']
//                             0                   1                 2                     3
const paises = ['', 'Argentina', 'Uruguay', 'Chile', 'Colombia', 'Venezuela', 'Méjico']
//                0            1         2          3           4          5 
...
function agregarPais() {
    const nuevoPais = prompt("Ingrese el país que desea agregar:")
    const resultado = paises.includes(nuevoPais)
    if (resultado) {
        console.warn("El país ingresado", nuevoPais, "ya existe en el array.")
        return
    }
    else {
